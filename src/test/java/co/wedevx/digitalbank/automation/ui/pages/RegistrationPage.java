...
// |title|firstName|lastname|gender|dob       |password|address   |locality|region|postalCode|country|homePhone |mobilePhone|workPhone |
    ...
    public void  fillOutRegistrationForm2(List<Map<String,String>>registrationPageTestDataListOfMap2){
        Select titleSelect=new Select(titleDropDown);
        Map<String,String> firstRow=registrationPageTestDataListOfMap2.get(0);
    ...
    public String getMessage(){
        return messageLabel.getText().substring(0,messageLabel.getText().lastIndexOf(".")+1);//should include . also
    }
    ...
    public String getRequiredFieldErrorMessage(String fieldName){
        ...
        switch (fieldName.toLowerCase()){
            case "title":
                return titleDropDown.getAttribute("validationMessage");// need to remember validationMessage
            case "firstname":
